...
$point = ($number_question/10)*$number_right;
...
<div class="flex_center mx-auto text-center">
    <h2>Xin chúc mừng: <?php echo $u_name; ?></h2>
    <h5 class="text-center">Đúng: <?php echo $number_right.' / '.$number_question; ?> câu</h5>
    <h5 class="text-center">Điểm: <?php echo $point; ?> câu</h5>
